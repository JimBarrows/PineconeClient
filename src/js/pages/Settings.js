	...
	render () {
		return (
			<div >
				...
				<KeywordsListPanel keywords = {this.state.keywords} deleteKeyword = {deleteKeyword}
													 saveKeyword = {saveKeyword} />
				<MessageListPanel messages = {this.state.messages} deleteMessage = {deleteMessage}
