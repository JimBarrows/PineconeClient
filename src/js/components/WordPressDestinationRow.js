...
export default class WordPressDestinationRow extends React.Component {
	...
	render() {
		...
		return (
				<tr>
					<td><input name="name" type="text" defaultValue={name} onChange={onChange}/></td>
					<td><input name="url" type="text" defaultValue={url} onChange={onChange}/></td>
					<td><input name="username" type="text" defaultValue={username} onChange={onChange}/></td>
					<td><input name="password" type="text" defaultValue={password} onChange={onChange}/></td>
					<td>
