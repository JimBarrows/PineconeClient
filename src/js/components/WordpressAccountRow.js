		...
		return (
			<tr >
				<EditableTextCell id = "name" type = "text" value = {name} onChange = {this.onChange.bind(this)}
													edit = {editing} />
				<EditableTextCell id = "password" type = "text" value = {password} onChange = {this.onChange.bind(this)}
													edit = {editing} />
				<EditableTextCell id = "url" type = "text" value = {url} onChange = {this.onChange.bind(this)}
													edit = {editing} />
				<EditableTextCell id = "username" type = "text" value = {username} onChange = {this.onChange.bind(this)}
													edit = {editing} />
				<td >
